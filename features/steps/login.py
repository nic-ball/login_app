...
def step_impl(context):
    ...
    # Create a dummy user for our tests (user is not authenticated at this point)
...
def step_impl(context):
    ...
    assert br.curent_url.endwith('/login/success')
...
def step_impl(context):
    ...
    assert br.curent_url.endswith('/login/fail')
